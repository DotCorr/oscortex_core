...
//   * NO BLOCKING RECEIVE. A receiver polls. GAP-0160.
...
// emitted. Everything else is already SMP-shaped. GAP-0165.
//
// ---------------------------------------------------------------------------
...
/// process id, and an endpoint is owned by one. GAP-0164.
...
void chanSysSend(u64 frame) {
  ...
  // IF is what serialises it. See this file's header, point 3, and GAP-0165.
...
void chanSysRecv(u64 frame) {
  ...
  // ACQUIRE FENCE goes here. GAP-0165.
  final u64 head = chanPort(port, chanHeadWord(d));
  final u64 tail = chanPort(port, chanTailWord(d));
  if (head < tail) {
    chanBumpMeta(u64(chanMetaCorrupt));
