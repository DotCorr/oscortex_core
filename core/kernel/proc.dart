...
u64 procCreate(u64 lba, u64 named) {
  ...
  // M20 (ADR-0027): THE PAGE REPORT IS TAKEN HERE, WHILE THE PROGRAM'S OWN CR3
  ...
  // `vmEffective` both do -- and before ADR-0027 the program's window lived in
  ...
  // -------------------------------------------------------------------------
  // M20 (ADR-0027): THE INITIAL PROCESS STACK, BUILT HERE RATHER THAN NOWHERE.
  //
