...
/// ordinary byte in it, so nine tables and nine call sites would buy nothing.
///
...
///
/// **621 bytes at M6**, up from 498 at M5, 395 at M4 and 237 at M3. That number is the
/// single hand-maintained literal in [shellHelp] below, and it is the number
/// that went wrong at M4 -- see docs/known-gaps.md GAP-0060. It is generated
/// rather than counted, and `tests/conformance/m6-disk/run.sh` reads the
/// symbol's real size out of the object file and compares it against what the
/// call site passes.
@rodata
final List<u8> shellStrHelp = const [
  ...
  u8(0x76), u8(0x65), u8(0x73), u8(0x0A), u8(0x20), u8(0x20), u8(0x63), u8(0x72), u8(0x61), u8(0x73), u8(0x68), u8(0x20),
  u8(0x75), u8(0x64), u8(0x20), u8(0x20), u8(0x20), u8(0x20), u8(0x20), u8(0x20), u8(0x66), u8(0x61), u8(0x75), u8(0x6C),
  u8(0x74), u8(0x20), u8(0x6F), u8(0x6E), u8(0x20), u8(0x70), u8(0x75), u8(0x72), u8(0x70), u8(0x6F), u8(0x73), u8(0x65),
  u8(0x20), u8(0x28), u8(0x23), u8(0x55), u8(0x44), u8(0x29), u8(0x20), u8(0x61), u8(0x6E), u8(0x64), u8(0x20), u8(0x63),
  u8(0x6F), u8(0x6D), u8(0x65), u8(0x20), u8(0x62), u8(0x61), u8(0x63), u8(0x6B), u8(0x0A), u8(0x20), u8(0x20), u8(0x63),
  u8(0x72), u8(0x61), u8(0x73), u8(0x68), u8(0x20), u8(0x64), u8(0x69), u8(0x76), u8(0x20), u8(0x20), u8(0x20), u8(0x20),
  u8(0x20), u8(0x66), u8(0x61), u8(0x75), u8(0x6C), u8(0x74), u8(0x20), u8(0x6F), u8(0x6E), u8(0x20), u8(0x70), u8(0x75),
  u8(0x72), u8(0x70), u8(0x6F), u8(0x73), u8(0x65), u8(0x20), u8(0x28), u8(0x23), u8(0x44), u8(0x45), u8(0x29), u8(0x20),
  u8(0x61), u8(0x6E), u8(0x64), u8(0x20), u8(0x63), u8(0x6F), u8(0x6D), u8(0x65), u8(0x20), u8(0x62), u8(0x61), u8(0x63),
  u8(0x6B), u8(0x0A), u8(0x20), u8(0x20), u8(0x65), u8(0x63), u8(0x68), u8(0x6F), u8(0x20), u8(0x3C), u8(0x72), u8(0x65),
  u8(0x73), u8(0x74), u8(0x3E), u8(0x20), u8(0x20), u8(0x20), u8(0x70), u8(0x72), u8(0x69), u8(0x6E), u8(0x74), u8(0x20),
  u8(0x74), u8(0x68), u8(0x65), u8(0x20), u8(0x72), u8(0x65), u8(0x73), u8(0x74), u8(0x20), u8(0x6F), u8(0x66), u8(0x20),
  u8(0x74), u8(0x68), u8(0x65), u8(0x20), u8(0x6C), u8(0x69), u8(0x6E), u8(0x65), u8(0x0A),
];
...
/// `help`
///
/// The length is 621 because the table is 621 bytes. It was 237 until M4 added
...
@bare
void shellHelp() {
  uartWrite(Rodata.addressOf(shellStrHelp), u64(621));
}
