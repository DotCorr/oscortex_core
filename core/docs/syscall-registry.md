...
| 16 | `shmcreate` | `shmSysCreateNo` | `core/kernel/shm.dart` | *(none)* | 0035 |
| 17 | `shmgrant` | `shmSysGrantNo` | `core/kernel/shm.dart` | *(none)* | 0035 |
| 18 | `shmmap` | `shmSysMapNo` | `core/kernel/shm.dart` | *(none)* | 0035 |
| 19 | `shmdrop` | `shmSysDropNo` | `core/kernel/shm.dart` | *(none)* | 0035 |
