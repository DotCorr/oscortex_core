#!/usr/bin/env python3
"""core/tests/conformance/d3-session/make-image.py

Writes the same 32-byte header-sector format m10-elf invented, carrying TWO
DIFFERENT resident compositor clients so `proc spawn <lba>` can start each.
