#!/usr/bin/env python3
"""core/tests/conformance/de-wall/make-image.py

FAT16 volume for wallpaper menu (ADR-0182). Plants WALL.DAT + WALL.RAW
(and optional companions). Geometry matches de-sitfat / de-chrome.
...
def main():
    ...
    if not order:
        raise SystemExit("make-image: need at least one plant")
