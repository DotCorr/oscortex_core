#!/usr/bin/env python3
"""FAT16 volume for plat-need5 (ADR-0165).

Full: PLAT.ELF + ASK.ELF + thirty-two stand-in .SO files.
Partial: same ELFs + thirty-one stand-ins (LIBLD.SO absent — no LINE32).
"""
