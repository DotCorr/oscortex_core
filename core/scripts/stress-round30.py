#!/usr/bin/env python3
"""Focused integrity/fault interval after a Round 30 kernel change."""
...
SECS = float(os.environ.get("DRIVE_STRESS_SECS", "90"))
...
def main():
    ...
    dest = os.path.join(ART, "oscortex-round30-integrity.json")
