#!/usr/bin/env python3
"""Sit in a fresh Round 23 UEFI boot: fb/wm/de/desk + FILES + SET."""
...
def main():
    if len(sys.argv) < 3:
        raise SystemExit("usage: sitin-round23.py <qmp> <serial>")
    port = int(sys.argv[1])
    ...
    if desk_only:
        print("sitin-round23: DESK ready (no FILES/SET)")
        return 0
    ...
    print("sitin-round23: DESK+FILES+SET ready")
    return 0
