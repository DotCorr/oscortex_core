#!/usr/bin/env python3
"""Round 20 visual stress: >=100 menus/focus + sustained drag/pointer."""
...
def main():
    ...
    shots = {
        "menu": os.path.join(art, "oscortex-round20-fast-menu-focus.png"),
        "drag": os.path.join(art, "oscortex-round20-smooth-drag.png"),
    }
    ...
    open(os.path.join(art, "oscortex-round20-frame-integrity.json"), "w").write(
