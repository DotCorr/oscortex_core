...
def matrix_one(q, ser, cap):
    ...
    delta = wait_token(ser, lambda d: focus_hit(d, w), 1.6, mark)
    ...
    delta = wait_token(ser, lambda d: any(s in d for s in want), 2.2, mark)
...
def main():
    ...
    if overview_show:
        ...
        try:
            ...
            pass
        kd = wait_token(ser, lambda d: "WM SWITCH SHOW" in d, 1.6, mark)
