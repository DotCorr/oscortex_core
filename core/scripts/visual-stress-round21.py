#!/usr/bin/env python3
"""Round 21 visual stress: >=100 menus/focus + sustained drag/pointer."""
...
def main():
    ...
    shots = {
        "menu": os.path.join(art, "oscortex-round21-fast-menu-focus.png"),
        "drag": os.path.join(art, "oscortex-round21-smooth-drag.png"),
    }
    ...
    open(os.path.join(art, "oscortex-round21-frame-integrity.json"), "w").write(
