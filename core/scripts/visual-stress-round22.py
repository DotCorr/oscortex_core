#!/usr/bin/env python3
"""Round 22 visual stress: >=100 menus/focus + sustained drag/pointer."""
...
def main():
    if len(sys.argv) < 4:
        raise SystemExit(
            "usage: visual-stress-round20.py <qmp> <serial> <outdir>")
    ...
    shots = {
        "menu": os.path.join(art, "oscortex-round22-fast-menu-focus.png"),
        "drag": os.path.join(art, "oscortex-round22-smooth-drag.png"),
    }
    d15.press(q, ser, 200, 180, "right", "WM WIN MENU", timeout=3)
