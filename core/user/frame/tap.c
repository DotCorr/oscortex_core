/* core/user/frame/tap.c
 *
 * TAP — a kept FRAME client that proves the closed app contract
 * (ADR-0112): ELF + osframe.h, chrome is wm, paint is client pixels
 * until osgfx/Skia lands. Compiles against osframe.h (no private
 * SYS_*). The de-apps harness builds it as TAP.ELF and starts it
 * with hidden `go TAP.ELF` (syscall 26 / ADR-0099).
 *
...
#define SURF_X 80UL
#define SURF_Y 80UL
#define SURF_FILL 0x00283818UL
#define CTL_X 40UL
#define CTL_Y 36UL
#define CTL_W 80UL
#define CTL_H 40UL
#define CTL_OFF 0x003080A0UL
...
static volatile u64 marker = 0x00A01120000011A0UL;
