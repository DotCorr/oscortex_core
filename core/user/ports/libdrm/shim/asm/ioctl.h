/* oscortex libdrm port — shim header: <asm/ioctl.h>
 *
 ...
 */
/* Linux's _IOC encoding, transcribed from include/uapi/asm-generic/ioctl.h. */
#ifndef _SHIM_ASM_IOCTL_H
#define _SHIM_ASM_IOCTL_H
